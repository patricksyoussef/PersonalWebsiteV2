...
I believe engineering is an act of stewardship: a way to build things people trust, respect, and actually want to use. Whether I’m crafting an API, debugging a simulation, or tweaking the tiniest UX detail, I’m chasing clarity, not cleverness. There’s joy in watching someone glide through a problem because of something I quietly thought through, and equal joy in the messy, unpolished moments no one ever sees that got me there.
