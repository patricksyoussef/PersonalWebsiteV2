...
slug: nbody
date: 2022-10-02
cover: images/feature_solar_crop.jpg
...
This post will introduce the principles behind predicting the motion of gravitationally interacting objects. Using Python, we'll implement the principles from scratch.

<PostVideo video={solar_anim} />
...
![Operation Count Comparison](./images/pair_comp.jpg)
