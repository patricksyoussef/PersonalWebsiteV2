...
slug: pf-slam
date: 2021-03-02
cover: images/feature_filter_crop.png
pinned: false
...
In this post we'll discuss an approach to solving the simultaneous localization and mapping (SLAM) problem for a vehicle and understand the shortcomings of the given implementation. Improvements will be suggested along the way alongside the state of the current results.
