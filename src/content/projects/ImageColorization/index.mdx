...
The goal of this project was to create a neural network to solve the problem of grayscale colorization, where an input grayscale image has missing channels amended such that we *estimate* a full color variant of the image. I opted to implement the model as detailed [here](https://arxiv.org/pdf/1712.03400v1.pdf).
