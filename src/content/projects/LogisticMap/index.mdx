...
slug: logistic-map
date: 2021-02-03
cover: images/feature_crossings_crop.jpg
pinned: false
...
This was a fun weekend project that I thought would be interesting to share as this is one of the prettier visualizations I've done in a bit. This post is a reflection of the entire [GitHub repository](https://github.com/patricksyoussef/LogisticMapVisualization/) so if you want to see more I advise you look into the actual codebase.
