...
The old site worked fine as a portfolio. It was clean, minimal, and focused on showcasing projects. But as my goals shifted, the format started to feel restrictive. I wanted the site to feel more like a living system, something I could grow into, not just look back on.
...
- The tech stack was bloated and annoying to update
...
If you’re here for the thinking behind the work, this is probably where it lives now.

# Updated Tone, Voice, and Feel

This redesign isn’t just about the words on the page, but it’s about how the whole site *feels* to interact with and the theme it presents for who I am.

The old version was rigid and minimal to a fault. It got out of the way, but it also felt flat and a little lifeless. The new version reflects a broader shift in intention: it’s more personal, more expressive, just more fun to use, and oh so very Patrick.
...
With the new stack, it was a welcome addition to the [gradient descent intro post](/blog/neural-net-gradient-descent#gradient-playground) where readers can now see what I was always hoping to share.

<PostVideo video={playground} alt="Example Interactions"/>

# What’s Next

The site’s new structure makes it easy to iterate—whether that’s adding new sections, improving performance, or shipping content faster.
